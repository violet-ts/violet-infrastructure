...
export interface TerraformAwsModulesRdsAwsOptions {
  /**
...
export class TerraformAwsModulesRdsAws extends TerraformModule {
  private readonly inputs: { [name: string]: any } = { }
  public constructor(scope: Construct, id: string, options: TerraformAwsModulesRdsAwsOptions) {
    super(scope, id, {
      source: 'terraform-aws-modules/rds/aws',
      version: '~> 3.0.0',
    });
    this.allocatedStorage = options.allocatedStorage;
    ...
    this.backupWindow = options.backupWindow;
    this.caCertIdentifier = options.caCertIdentifier;
    this.characterSetName = options.characterSetName;
    this.copyTagsToSnapshot = options.copyTagsToSnapshot;
    this.createDbInstance = options.createDbInstance;
    this.createDbOptionGroup = options.createDbOptionGroup;
    this.createDbParameterGroup = options.createDbParameterGroup;
    this.createDbSubnetGroup = options.createDbSubnetGroup;
    this.createMonitoringRole = options.createMonitoringRole;
    this.createRandomPassword = options.createRandomPassword;
    this.dbInstanceTags = options.dbInstanceTags;
    this.dbOptionGroupTags = options.dbOptionGroupTags;
    this.dbParameterGroupTags = options.dbParameterGroupTags;
    this.dbSubnetGroupDescription = options.dbSubnetGroupDescription;
    this.dbSubnetGroupName = options.dbSubnetGroupName;
    this.dbSubnetGroupTags = options.dbSubnetGroupTags;
    this.dbSubnetGroupUseNamePrefix = options.dbSubnetGroupUseNamePrefix;
    this.deleteAutomatedBackups = options.deleteAutomatedBackups;
    this.deletionProtection = options.deletionProtection;
    this.domain = options.domain;
    this.domainIamRoleName = options.domainIamRoleName;
    this.enabledCloudwatchLogsExports = options.enabledCloudwatchLogsExports;
    this.engine = options.engine;
    this.engineVersion = options.engineVersion;
    this.family = options.family;
    this.finalSnapshotIdentifier = options.finalSnapshotIdentifier;
    ...
    this.iops = options.iops;
    this.kmsKeyId = options.kmsKeyId;
    this.licenseModel = options.licenseModel;
    this.maintenanceWindow = options.maintenanceWindow;
    this.majorEngineVersion = options.majorEngineVersion;
    this.maxAllocatedStorage = options.maxAllocatedStorage;
    this.monitoringInterval = options.monitoringInterval;
    this.monitoringRoleArn = options.monitoringRoleArn;
    this.monitoringRoleName = options.monitoringRoleName;
    this.multiAz = options.multiAz;
    this.name = options.name;
    this.optionGroupDescription = options.optionGroupDescription;
    this.optionGroupName = options.optionGroupName;
    this.optionGroupTimeouts = options.optionGroupTimeouts;
    this.optionGroupUseNamePrefix = options.optionGroupUseNamePrefix;
    this.options = options.options;
    this.parameterGroupDescription = options.parameterGroupDescription;
    this.parameterGroupName = options.parameterGroupName;
    this.parameterGroupUseNamePrefix = options.parameterGroupUseNamePrefix;
    ...
    this.performanceInsightsRetentionPeriod = options.performanceInsightsRetentionPeriod;
    this.port = options.port;
    this.publiclyAccessible = options.publiclyAccessible;
    this.randomPasswordLength = options.randomPasswordLength;
    this.replicateSourceDb = options.replicateSourceDb;
  ...
  public get allocatedStorage(): string {
    return this.inputs['allocated_storage'] as string;
  }
  ...
  public get backupWindow(): string {
    return this.inputs['backup_window'] as string;
  }
  ...
  public get engine(): string {
    return this.inputs['engine'] as string;
  }
  public set engine(value: string) {
    this.inputs['engine'] = value;
  }
  public get engineVersion(): string {
    return this.inputs['engine_version'] as string;
  }
  ...
  public get instanceClass(): string {
    return this.inputs['instance_class'] as string;
  }
  ...
  public get maintenanceWindow(): string {
    return this.inputs['maintenance_window'] as string;
  }
  ...
  public get port(): string {
    return this.inputs['port'] as string;
  }
  ...
  public get username(): string {
    return this.inputs['username'] as string;
  }
  ...
  public get dbInstanceAddressOutput() {
    return this.interpolationForOutput('db_instance_address')
  }
  public get dbInstanceArnOutput() {
    return this.interpolationForOutput('db_instance_arn')
  }
  public get dbInstanceAvailabilityZoneOutput() {
    return this.interpolationForOutput('db_instance_availability_zone')
  }
  public get dbInstanceCaCertIdentifierOutput() {
    return this.interpolationForOutput('db_instance_ca_cert_identifier')
  }
  public get dbInstanceDomainOutput() {
    return this.interpolationForOutput('db_instance_domain')
  }
  public get dbInstanceDomainIamRoleNameOutput() {
    return this.interpolationForOutput('db_instance_domain_iam_role_name')
  }
  public get dbInstanceEndpointOutput() {
    return this.interpolationForOutput('db_instance_endpoint')
  }
  public get dbInstanceHostedZoneIdOutput() {
    return this.interpolationForOutput('db_instance_hosted_zone_id')
  }
  public get dbInstanceIdOutput() {
    return this.interpolationForOutput('db_instance_id')
  }
  public get dbInstanceNameOutput() {
    return this.interpolationForOutput('db_instance_name')
  }
  public get dbInstancePasswordOutput() {
    return this.interpolationForOutput('db_instance_password')
  }
  public get dbInstancePortOutput() {
    return this.interpolationForOutput('db_instance_port')
  }
  public get dbInstanceResourceIdOutput() {
    return this.interpolationForOutput('db_instance_resource_id')
  }
  public get dbInstanceStatusOutput() {
    return this.interpolationForOutput('db_instance_status')
  }
  public get dbInstanceUsernameOutput() {
    return this.interpolationForOutput('db_instance_username')
  }
  public get dbMasterPasswordOutput() {
    return this.interpolationForOutput('db_master_password')
  }
  public get dbOptionGroupArnOutput() {
    return this.interpolationForOutput('db_option_group_arn')
  }
  public get dbOptionGroupIdOutput() {
    return this.interpolationForOutput('db_option_group_id')
  }
  public get dbParameterGroupArnOutput() {
    return this.interpolationForOutput('db_parameter_group_arn')
  }
  public get dbParameterGroupIdOutput() {
    return this.interpolationForOutput('db_parameter_group_id')
  }
  public get dbSubnetGroupArnOutput() {
    return this.interpolationForOutput('db_subnet_group_arn')
  }
  public get dbSubnetGroupIdOutput() {
    return this.interpolationForOutput('db_subnet_group_id')
  }
  public get enhancedMonitoringIamRoleArnOutput() {
    return this.interpolationForOutput('enhanced_monitoring_iam_role_arn')
  }
  public get enhancedMonitoringIamRoleNameOutput() {
    return this.interpolationForOutput('enhanced_monitoring_iam_role_name')
  }
